...
def main(config):
    ...
    # 加载数据
    dataset = MyDataset(
        config["evaluate_dataset"]["data_dir"],
    ...
    with torch.no_grad():
        ...
        for i, (data) in enumerate(data_loader):
            ...
            padded_source = padded_source.squeeze(0)
            ...
            padded_source = padded_source.unsqueeze(0)
...
if __name__ == "__main__":
    ...
    # )
    path = r"config/test/evaluate.json5"
